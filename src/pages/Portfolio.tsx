...
import { ArrowLeft, ExternalLink, Code, Palette, Smartphone, ShoppingCart, Wrench, Monitor } from 'lucide-react';
...
const Portfolio = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Secure, user-friendly online stores that drive sales and provide excellent shopping experiences."
    },
    {
      icon: Wrench,
